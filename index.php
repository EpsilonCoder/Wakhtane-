        ...
        <div class="content">
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    <!--Package One-->
                    <h2>les champs avec les etoites rouge sont obligatoires</h2>
                    <hr>
                    <!--First Name-->
                    ...
                    echo '<option value="2">Fevrier</option>';
                    ...
                    <br>
                    <!--Package Two-->
                    <h2>Information Additionelle</h2>
                    <hr>
                    <!--Marital Status-->
                    ...
                    <br><br>
                    <input type="submit" value="Creer un compte" name="register">
                </form>
            </div>
        </div>
    </div>
    ...
    if (isset($_POST['login'])) { // Login process
        ...
        if($query){
            if(mysqli_num_rows($query) == 1) {
                ...
                ?> <script>
                    document.getElementsByClassName("required")[0].innerHTML = "Remplissez ce champ";
                    document.getElementsByClassName("required")[1].innerHTML = "Remplissez ce champ";
                </script> <?php
            }
        } else{
